...
<br/>
<h4><b>Log Book</b></h4>
<h4>Report by Month</h4>
<h5><?php echo $smloga; ?> Minute </h5>
...
<table >
		...
		<?php
		$res = $link->query("SELECT * FROM log_book WHERE username='" .$nm. "' AND mt='" .$mt. "'");
		while ($rw = $res->fetch_assoc()):
		?>
			<tr >
				<td><?php echo $rw['tgl'] ?></td>
				<td><img src="../up/log/<?php echo $rw ['pic']; ?>" alt="image" width="100px" height="100px"></td>
