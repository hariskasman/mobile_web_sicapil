...
<body>
<form name="sum" action="../inc/d18b.php" method="post">
	<div align="center">
        <table border="0" cellpadding="5px" cellspacing="1px" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; background-color:#000000" width="20%">
										<tr>
										...
										<tr>
											...
											<td style="background-color:#ffffff"><input type="text" name="total" value="<?php echo $total_bill ?>" onFocus="startCalc();" onBlur="stopCalc();" readonly></td>
                                        </tr>
										<tr>
