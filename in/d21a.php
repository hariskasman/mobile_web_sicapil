...
<div class="login-form padding20 block-shadow">
		<form action="../inc/d21a.php" method="post" enctype="multipart/form-data">
				<div align="center">
				<h1 class="text-light"><small><h3>Tambah Berkas</h3></small></h1>
				...
				<div class="input-control text full-size" data-role="input">
				DESCRIPTION :			
				<input type="text" placeholder="description.." name="kerja" value="" size="25" >				
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				<input type="hidden" placeholder="menit.." name="menit" value="" size="25" >				
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
