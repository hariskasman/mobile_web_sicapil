...
<div class="login-form padding20 block-shadow">
		<form action="../inc/d17a.php" method="post">
				<div align="center">
				...
				Code : 
				<input type="text" placeholder="product code.." name="serial" value="" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				...
				<div class="input-control text full-size" data-role="input">
				Unit : 
				<input type="text" placeholder="unit product.." name="unit" value="" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				Price : 
				<input type="text" placeholder="price.." name="price" value="" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				Profit : 
				<input type="text" placeholder="profit.." name="profit" value="" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
