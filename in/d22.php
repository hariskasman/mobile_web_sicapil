...
<?php include ("../sec/amenu.php"); ?>
		...
		<?php
		$res = $link->query("SELECT * FROM pengguna WHERE log='" .$_SESSION['stores']. "'");
		...
		?>
			...
			<tr align="center">
				...
				<td>
				<a href="d22d.php?u=<?php echo $rw['codx']; ?>"><button class="button">DAY</button></a>
				<a href="d22m.php?u=<?php echo $rw['codx']; ?>"><button class="button">MO</button></a>
				<a href="d22y.php?u=<?php echo $rw['codx']; ?>"><button class="button">YR</button></a>
				</td>
			</tr>
