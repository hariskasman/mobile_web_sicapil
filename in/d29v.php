...
<div class="login-form padding20 block-shadow">
		<form action="../inc/d29a.php" name="sm" method="post">
				<div align="center">
				<h1 class="text-light"><small><h3>MOVE ITEM</h3></small></h1>
				...
				<div class="input-control text full-size" data-role="input">
				QTY PINDAH :			
				<input type="text" placeholder="qty pindah.." name="qty" onFocus="rumus();" onBlur="srumus();" value="" size="25" >				
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				QTY SISA :			
				<input type="text" placeholder="qty sisa.." name="sisa" value="" size="25" readonly>				
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
