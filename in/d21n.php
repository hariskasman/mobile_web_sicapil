...
<table border="0.5px" style="background-color:#FFFFFF;" size="50" align="center" class="table table-striped table-bordered table-hover border bordered" id="dataTables-example" >
		...
		?>
			...
			<tr align="center">
				...
				<td><a class="fa fa-file-image-o" href="../up/log/<?php echo $rw ['pic']; ?>" onclick="../up/log/<?php echo $rw ['pic']; ?>">Data</a></td>
			</tr>
...
<div class="login-form padding20 block-shadow">
		...
		<form action="../inc/d21n.php" method="post" enctype="multipart/form-data">
				<div align="center">
