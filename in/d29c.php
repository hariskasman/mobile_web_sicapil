...
<div class="login-form padding20 block-shadow">
		<form action="../inc/d29c.php" name="sm" method="post">
				<div align="center">
				<h1 class="text-light"><small><h3>CHANGE ITEM</h3></small></h1>
				...
				ITEM PIC :			
				<input type="text" placeholder="picture item.." name="ipic" value="<?php echo $rsa ['ipic']; ?>" size="25" >
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
				...
				<div class="input-control text full-size" data-role="input">
				QTY :			
				<input type="text" placeholder="qty.." name="qty" value="<?php echo $rsa ['qty']; ?>" onFocus="rumus();" onBlur="srumus();" size="25" >				
				</div>
				<br/>
				<br/>
				<div class="input-control text full-size" data-role="input">
